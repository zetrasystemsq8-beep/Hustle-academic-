...
/// A single node in a Flutter project's editable file tree. Scoped
/// intentionally to `lib/` and `pubspec.yaml` — the parts of a real
/// Flutter project a student actually writes. Native scaffolding
/// (`android/`, `ios/`, build config) is generated by Build Farm at
/// compile time, the same way a browser's internals were never
/// something Web Lab asked students to hand-edit.
...
/// A Flutter project: a name, its editable file tree, and metadata
/// needed by Build Farm and GitHub Integration once those exist.
class MobileProject {
  final String id;
  String name;
  MobileFileNode root;
  ...
  /// A minimal, real, valid Flutter project — a counter app, the same
  /// starting point `flutter create` itself generates. Not a stripped
  /// toy: this genuinely compiles and runs once passed through Build
  /// Farm.
...
// ============================================================
// FILE SYSTEM OPERATIONS — create/rename/delete/duplicate/move
// ============================================================
...
// ============================================================
// SYNTAX HIGHLIGHTING — real Dart and YAML tokenizers
// ============================================================
...
// ============================================================
// EDITOR STATE — open tabs, undo/redo, search
// ============================================================
